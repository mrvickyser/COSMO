...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By SPlRlT SER' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'SPlRlT-YT' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴘɪʀɪᴛ sᴇʀ࿐' : process.env.BOT_NAME,
